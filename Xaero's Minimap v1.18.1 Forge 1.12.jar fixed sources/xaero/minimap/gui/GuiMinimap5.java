...
extends GuiSettings {
    ...
    public GuiMinimap5(IXaeroMinimap modMain, GuiScreen par1GuiScreen) {
        ...
        this.options = new ModOptions[]{ModOptions.HIDE_WORLD_NAMES, ModOptions.CAPES, ModOptions.AA, ModOptions.SMOOTH_DOTS, ModOptions.SAFE_MAP, ModOptions.RENDER_LAYER, ModOptions.RESET};
    }
