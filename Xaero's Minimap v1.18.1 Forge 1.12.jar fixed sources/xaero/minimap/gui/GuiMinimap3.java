...
import xaero.minimap.gui.GuiMinimap4;
...
extends GuiSettings {
    ...
    public GuiMinimap3(IXaeroMinimap modMain, GuiScreen par1GuiScreen) {
        ...
        this.options = new ModOptions[]{ModOptions.COLOURS, ModOptions.LIGHT, ModOptions.COMPASS, ModOptions.ARROW_COLOUR, ModOptions.OPACITY, ModOptions.ARROW_SCALE, ModOptions.REDSTONE, ModOptions.FLOWERS, ModOptions.ENTITY_HEIGHT, ModOptions.PLAYER_HEADS, ModOptions.HEIGHT_LIMIT, ModOptions.PLAYER_NAMES};
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton) {
        ...
        if (par1GuiButton.enabled) {
            ...
            if (par1GuiButton.id == 202) {
                this.mc.displayGuiScreen((GuiScreen)new GuiMinimap4(this.modMain, this.parentGuiScreen));
            }
